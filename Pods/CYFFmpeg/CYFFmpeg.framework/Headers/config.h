...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-shared --enable-static --enable-debug --disable-doc --enable-pic --enable-libfdk-aac --enable-nonfree --enable-gpl --enable-version3 --enable-libsmbclient --extra-cflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode -I/usr/local/Cellar/fdk-aac/include -I/usr/local/Cellar/smbclient/include' --extra-ldflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode -L/usr/local/Cellar/fdk-aac/lib -L/usr/local/Cellar/smbclient/lib' --prefix=/Users/yellowei/Documents/GitHub/FFmpeg/FFmpeg-iOS-noX264-smb-fdkaac-disable_shared/thin/arm64"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/yellowei/Documents/GitHub/FFmpeg/FFmpeg-iOS-noX264-smb-fdkaac-disable_shared/thin/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/yellowei/Documents/GitHub/FFmpeg/FFmpeg-iOS-noX264-smb-fdkaac-disable_shared/thin/arm64/share/ffmpeg"
